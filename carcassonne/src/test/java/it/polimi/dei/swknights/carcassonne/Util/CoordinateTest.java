...
public class CoordinateTest
{
	...
	public void g() throws Exception
	{
		...
		this.pezzaliSortCoordinates(listGOT);
		this.pezzaliSortCoordinates(listEXP);
	...
	private class CoordPunto
	{
		...
		public int hashCode()
		{
			...
			result = prime * result + ((this.punto == null) ? 0 : this.punto.hashCode());
			return result;
		}
		...
		public boolean equals(Object obj)
		{
			...
			if (!this.getOuterType().equals(other.getOuterType())) { return false; }
			if (this.coord == null)
			{
				if (other.coord != null) { return false; }
			}
			else if (!this.coord.equals(other.coord)) { return false; }
			if (this.punto != other.punto) { return false; }
			return true;
		}

		public CoordPunto(Coordinate c, PuntoCardinale p)
		{
			this.coord = c;
			this.punto = p;
		}
