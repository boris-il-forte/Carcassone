...
public class Riga
{
	...
	/**
	 * 
	 * @param coordinataX: the x value of the wanted card in the row
	 * e.g. addTessera(5, validCard) will put a card in (5, r) 
	 * when r is the row number if the (5,r) is free
	 * @param tessera:
	 */
	 ...
	 * 
	 * @param coordinataX: the x value of the wanted card in the row
	 * e.g. addTessera(5, validCard) will get the card in (5, r) 
	 * when r is the row number
